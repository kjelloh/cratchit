The Swedish tax agency (Skatteverket or SKV) provides a zip repo with xlsx-files that specifies the file formats for upload to their file upload web interface.
